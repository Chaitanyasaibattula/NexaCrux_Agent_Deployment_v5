    ...
    <div className="min-h-screen bg-nexa-black">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="sector-card glass-card rounded-2xl overflow-hidden group cursor-pointer">
              <div className="relative h-64">
                <img src={`${baseUrl}assets/sector-residential.png`} alt="Luxury Residential" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
            ...
            <div className="sector-card glass-card rounded-2xl overflow-hidden group cursor-pointer">
              <div className="relative h-64">
                <img src={`${baseUrl}assets/sector-commercial.png`} alt="Commercial Hubs" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-nexa-black/95 via-nexa-black/50 to-transparent"></div>
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="flex items-center gap-3 mb-2">
            ...
            <div className="sector-card glass-card rounded-2xl overflow-hidden group cursor-pointer">
              <div className="relative h-64">
                <img src={`${baseUrl}assets/sector-education.png`} alt="Education" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-nexa-black/95 via-nexa-black/50 to-transparent"></div>
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="flex items-center gap-3 mb-2">
            ...
            <div className="sector-card glass-card rounded-2xl overflow-hidden group cursor-pointer">
              <div className="relative h-64">
                <img src={`${baseUrl}assets/sector-healthcare.png`} alt="Healthcare" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                <div className="absolute inset-0 bg-gradient-to-t from-nexa-black/95 via-nexa-black/50 to-transparent"></div>
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="flex items-center gap-3 mb-2">
      ...
      <section id="sustainability" className="relative py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="mb-12">
            <div className="relative rounded-2xl overflow-hidden border border-white/10">
              <img src={`${baseUrl}assets/sustainability-traffic.jpg`} alt="60% Reduction in Courier Traffic" className="w-full h-auto object-cover" />
            </div>
          </div>
